...
$row = mysqli_query($connect,"SELECT * FROM teams WHERE teamName='$winner'");
...
if($entry["member1"] != 0 && $entry["member1"] != NULL){
	...
	$user1Loss = $user1Vector["Wins"];
	$user1Loss = $user1Loss + 1;
	$updateUser1 = $connect->query("UPDATE usernames SET Wins='$user1Loss' WHERE id='$member1'");
}
if($entry["member2"] != 0 && $entry["member2"] != NULL){
	...
	$user2Loss = $user2Vector["Wins"];
	$user2Loss = $user2Loss + 1;
	$updateUser2 = $connect->query("UPDATE usernames SET Wins='$user2Loss' WHERE id='$member2'");
...
if($entry["member3"] != 0 && $entry["member3"] != NULL){
	...
	$user3Loss = $user3Vector["Wins"];
	$user3Loss = $user3Loss + 1;
	$updateUser3 = $connect->query("UPDATE usernames SET Wins='$user3Loss' WHERE id='$member3'");
...
if($entry["member4"] != 0 && $entry["member4"] != NULL){
	...
	$user4Loss = $user4Vector["Wins"];
	$user4Loss = $user4Loss + 1;
	$updateUser4 = $connect->query("UPDATE usernames SET Wins='$user4Loss' WHERE id='$member4'");
...
if($entry["member5"] != 0 && $entry["member5"] != NULL){
	...
	$user5Loss = $user5Vector["Wins"];
	$user5Loss = $user5Loss + 1;
	$updateUser5 = $connect->query("UPDATE usernames SET Wins='$user5Loss' WHERE id='$member5'");

	
}

$changeWins = mysqli_query($connect,"UPDATE teams SET Wins='$oldScore' WHERE teamName='$winner'");
$connect->close();
